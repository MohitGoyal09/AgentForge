...
from agentforge_harness.utils.errors import ConfigError
import logging
...
AGENT_MD_FILES = ("AGENTS.md", "AGENT.MD")
...
def _get_agent_md_files(cwd: Path) -> str | None:
    ...
    if current.is_dir():
        for file_name in AGENT_MD_FILES:
            agent_md_file = current / file_name
